...
class EurekaRegistry {
    constructor(_logger) {
        this.logger = _logger;
        const SERVICE_NAME = process.env.SVC_NAME;
        const SERVICE_VERSION = process.env.SVC_VERSION; // interface-info (for REST) 
        const SERVICE_BUILD = process.env.SVC_BUILD; // build-info (for logging)
...
exports.EurekaRegistry = EurekaRegistry;
